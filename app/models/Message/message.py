...
class Message(models.Model):
    ...
    creator = models.ForeignKey('User', on_delete=models.CASCADE, related_name="created_messages", to_field="user_id")
    receiver = models.ForeignKey('User', on_delete=models.CASCADE, related_name="received_messages", to_field="user_id")
